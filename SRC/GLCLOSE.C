...
GLfinals()
{
   ...
   if (iyear > 90 && iyear <= 99) {
    ...
    } else if (iyear >= 0 && iyear < 20) {    // 50j == Year 2000
    	sprintf(incacct,"50%c",'a'+iyear+100-91); // for 2000, iyear is 0, a+9 is j 
...
if (nextyear[0] == '9' &&  nextyear[1] == '9' )	{      // 99+1 is 00
	strcpy ( nextyear, "00" );  	
} else if (nextyear[1] == '9') {
	nextyear[0]++;
	nextyear[1] = '0';
} else {
	nextyear[1]++;
